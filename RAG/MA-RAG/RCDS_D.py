...
from help_functions import (
    ...
    format_chunks, parse_scores, call_llm, load_version, normalize_answer, has_consensus, has_stabilized,
    all_unsure
)
    ...
    with open(OUTPUT_PATH, "w", encoding="utf-8") as out_f:
        for i, q in enumerate(questions):
            ...
            for r in range(1, MAX_DEBATE_ROUNDS + 1):
                ...
                # Hard deadlock: ingen reelle debattanter flytter seg på 2 runder
